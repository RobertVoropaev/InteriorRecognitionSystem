...
def get_model(img_shape, classes_num, last_activation):
    ...
    block1_pool1 = MaxPool2D(2)(block1_conv4)
    ...
    block2_pool1 = MaxPool2D(2)(block2_conv4)
    ...
    block3_pool1 = MaxPool2D(2)(block3_conv4)
    ...
    block4_upsa1 = UpSampling2D(2, interpolation="bilinear")(block4_conv4)

    block5_conc1 = Concatenate()([block3_conv4, block4_upsa1])
    ...
    block5_upsa1 = UpSampling2D(2, interpolation="bilinear")(block5_conv4)

    block6_conc1 = Concatenate()([block2_conv4, block5_upsa1])
    ...
    block6_upsa1 = UpSampling2D(2, interpolation="bilinear")(block6_conv4)

    block7_conc1 = Concatenate()([block1_conv4, block6_upsa1])
    ...
    block8_output = Conv2D(classes_num, (1, 1), padding="same", activation=last_activation)(block7_conv4)
