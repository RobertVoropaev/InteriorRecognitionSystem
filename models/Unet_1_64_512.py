...
def get_model(img_shape, classes_num, last_activation):
    ...
    block1_pool1 = MaxPool2D(2)(block1_conv1)

    block2_conv1 = Conv2D(128, (3, 3), padding="same", activation="relu")(block1_pool1)
    block2_pool1 = MaxPool2D(2)(block2_conv1)

    block3_conv1 = Conv2D(256, (3, 3), padding="same", activation="relu")(block2_pool1)
    block3_pool1 = MaxPool2D(2)(block3_conv1)

    block4_conv1 = Conv2D(512, (3, 3), padding="same", activation="relu")(block3_pool1)
    block4_upsa1 = UpSampling2D(2, interpolation="bilinear")(block4_conv1)

    block5_conc1 = Concatenate()([block3_conv1, block4_upsa1])
    ...
    block6_conc1 = Concatenate()([block2_conv1, block5_upsa1])
    block6_conv1 = Conv2D(128, (3, 3), padding="same", activation="relu")(block6_conc1)
    block6_upsa1 = UpSampling2D(2, interpolation="bilinear")(block6_conv1)

    block7_conc1 = Concatenate()([block1_conv1, block6_upsa1])
    block7_conv1 = Conv2D(64, (3, 3), padding="same", activation="relu")(block7_conc1)

    block8_output = Conv2D(classes_num, (1, 1), padding="same", activation=last_activation)(block7_conv1)
