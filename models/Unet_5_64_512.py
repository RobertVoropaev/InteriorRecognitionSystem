...
def get_model(img_shape, classes_num, last_activation):
    ...
    block1_conv4 = Conv2D(64, (3, 3), padding="same", activation="relu")(block1_conv3)
    block1_conv5 = Conv2D(64, (3, 3), padding="same", activation="relu")(block1_conv4)
    block1_pool1 = MaxPool2D(2)(block1_conv5)
    ...
    block2_conv4 = Conv2D(128, (3, 3), padding="same", activation="relu")(block2_conv3)
    block2_conv5 = Conv2D(128, (3, 3), padding="same", activation="relu")(block2_conv4)
    block2_pool1 = MaxPool2D(2)(block2_conv5)
    ...
    block3_conv4 = Conv2D(256, (3, 3), padding="same", activation="relu")(block3_conv3)
    block3_conv5 = Conv2D(256, (3, 3), padding="same", activation="relu")(block3_conv4)
    block3_pool1 = MaxPool2D(2)(block3_conv5)
    ...
    block4_conv4 = Conv2D(512, (3, 3), padding="same", activation="relu")(block4_conv3)
    block4_conv5 = Conv2D(512, (3, 3), padding="same", activation="relu")(block4_conv4)
    block4_upsa1 = UpSampling2D(2, interpolation="bilinear")(block4_conv5)

    block5_conc1 = Concatenate()([block3_conv5, block4_upsa1])
    ...
    block5_conv4 = Conv2D(256, (3, 3), padding="same", activation="relu")(block5_conv3)
    block5_conv5 = Conv2D(256, (3, 3), padding="same", activation="relu")(block5_conv4)
    block5_upsa1 = UpSampling2D(2, interpolation="bilinear")(block5_conv5)

    block6_conc1 = Concatenate()([block2_conv5, block5_upsa1])
    ...
    block6_conv4 = Conv2D(128, (3, 3), padding="same", activation="relu")(block6_conv3)
    block6_conv5 = Conv2D(128, (3, 3), padding="same", activation="relu")(block6_conv4)
    block6_upsa1 = UpSampling2D(2, interpolation="bilinear")(block6_conv5)

    block7_conc1 = Concatenate()([block1_conv5, block6_upsa1])
    ...
    block7_conv4 = Conv2D(64, (3, 3), padding="same", activation="relu")(block7_conv3)
    block7_conv5 = Conv2D(64, (3, 3), padding="same", activation="relu")(block7_conv4)

    block8_output = Conv2D(classes_num, (1, 1), padding="same", activation=last_activation)(block7_conv5)
